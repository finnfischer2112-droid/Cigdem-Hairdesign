...
const images = [
  { src: `${import.meta.env.BASE_URL}images/gallery-1.jpeg`, position: "center 30%", scale: 1 },
  ...
  { src: `${import.meta.env.BASE_URL}images/gallery-4.jpeg`, position: "center", scale: 1.5 },
